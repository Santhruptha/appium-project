...
public class installApp {
	...
	public void installapp() throws MalformedURLException
	{
		...
		cap.setCapability(MobileCapabilityType.APP, "C:\\TY files\\Apk files\\Touch Screen Test_v1.7.14_apkpure.com.apk");
		
		URL url=new URL("http://localhost:4723/wd/hub");
		AndroidDriver driver=new AndroidDriver(url, cap);
		//driver.installApp("C:\TY files\Apk files\Touch Screen Test_v1.7.14_apkpure.com.apk");
